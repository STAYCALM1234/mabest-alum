...
import {
  Upload, Image as ImageIcon, GraduationCap, LogOut,
  Calendar, User, Trash2, Plus, X, Camera
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        >
          ...
          <p className="text-blue-200">Share your memories with other alumni.</p>
        </motion.div>
        ...
        >
          ...
          {userImages.length === 0 ? (
            <div className="text-center py-12 text-white">You haven't uploaded any photos yet.</div>
          ) : (
              ...
              {userImages.map(image => (
                ...
                >
                  ...
                  <div className="p-3 text-white">
                    ...
                    <p className="text-sm text-blue-200">{new Date(image.uploadedAt).toLocaleDateString()}</p>
                  </div>
                </div>
              ))}
            </div>
